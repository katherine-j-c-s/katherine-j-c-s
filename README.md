...
I am always looking for new skills and knowledge🎓considering myself an autodidact passionate about constantly learning. I like going to the gym 💪 and spend time with my family 👨‍👩‍👧‍👧 Currently, I am working as a **Full Stack Developer** at **Simetra**, developing enterprise-level applications for construction companies. My value proposition lies in my way to adapt to any situations, which makes my projects as a programmer easier to do. 💡💪
...
- 💬 Ask me about **React, TypeScript, Python, FastAPI, PostgreSQL, Tauri**

- 📫 How to reach me **kathijcs@gmial.com**

- 💼 Currently working at **Simetra** - Building scalable desktop and web applications
...
### 🏗️ **Full Stack Developer at Simetra**

**Current Role** - Developing enterprise-level construction management systems

**Key Projects:**
- **Construction Quotation System**: Full-stack application for construction companies to manage complex quotations, budgets, and offers
  - Built with **FastAPI** (Python) backend and **Tauri + React + TypeScript** desktop application
  - Implemented complex hierarchical data structures (Works → Items → Resources → Materials → Costs)
  - Developed role-based access control system (Admin, Estimator, Commercial)
  - Created Excel import/export functionality with data cleaning algorithms using Pandas
  - Implemented automatic cost calculations and totals
  - Designed flexible material type system with custom headers (JSONB)
  - Built complete workflow system with state management (borrador → pendiente → finalizada → aprobada/rechazada)

**Technologies Used:**
- Backend: FastAPI, PostgreSQL, SQLAlchemy, Pydantic, JWT Authentication
- Frontend: React, TypeScript, Tauri, Tailwind CSS, Zustand, Framer Motion
- Database: PostgreSQL with JSONB for flexible data structures
- DevOps: Docker, Docker Compose
- Tools: Git, VS Code, Postman, Jira

**Achievements:**
- ✅ Designed and implemented complete quotation workflow system
- ✅ Created flexible catalog management system for resources, materials, personnel, and equipment
- ✅ Developed Excel processing algorithms for bulk data import
- ✅ Implemented automatic cost calculation engine
- ✅ Built responsive desktop application with modern UI/UX
